  ...
  return (
    <div className="bg-[#111114] rounded-2xl p-5 border border-white/[0.07] text-center hover:border-purple-500/20 hover:-translate-y-0.5 transition-all duration-200">
      ...
      <Link to={`/profile/${user.id}`}>
        <button className="mt-4 w-full py-2 rounded-xl bg-white/[0.05] hover:bg-purple-600 border border-white/[0.07] hover:border-purple-500 text-gray-300 hover:text-white text-xs font-semibold transition-all duration-200">
          View Profile
        </button>
      </Link>
    </div>
